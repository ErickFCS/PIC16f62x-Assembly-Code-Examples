...
init:
    ...
    BCF TRISB, 0 ; pinMode ((PORTB) and 07Fh), 0 output(0)
    ...
    BCF PORTB, 0 ; set ((PORTB) and 07Fh), 0 to 0
    MOVLW 0x02 ; w=0x02
    MOVWF help ; help=w=0x02

    BSF INTCON, 5 ; INTCON(2)=((INTCON) and 07Fh), 2=0
    BSF INTCON, 7 ; INTCON(2)=((INTCON) and 07Fh), 2=0
...
interrupt:
    ...
    MOVLW 0x01 ; w=0x01
    XORWF PORTB, F ; ((PORTB) and 07Fh), 0 = !((PORTB) and 07Fh), 0
    MOVLW 0x02 ; w=0x02
    MOVWF help ; help=w=0x02
    RETURN
    END main
