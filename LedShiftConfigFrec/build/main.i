...
init:
    ...
    BCF OPTION_REG, 5 ; OPTION_REG(5)=0 ((OPTION_REG) and 07Fh), 5=0
    BCF OPTION_REG, 3 ; OPTION_REG(3)=0 ((OPTION_REG) and 07Fh), 3=0
    BSF OPTION_REG, 0 ; OPTION_REG(0)=1 ((OPTION_REG) and 07Fh), 0=1
    BSF OPTION_REG, 1 ; OPTION_REG(1)=1 ((OPTION_REG) and 07Fh), 1=1
    BSF OPTION_REG, 2 ; OPTION_REG(2)=1 ((OPTION_REG) and 07Fh), 2=1
    MOVLW 0xe0
    MOVWF TRISA
    MOVLW 0xf0
    MOVWF TRISB
    ...
    BCF INTCON, 2 ; INTCON(2)=((INTCON) and 07Fh), 2=0
    BSF INTCON, 5 ; INTCON(5)=((INTCON) and 07Fh), 5=1
    BCF INTCON, 0 ; INTCON(0)=((INTCON) and 07Fh), 0=0
    BSF INTCON, 3 ; INTCON(3)=((INTCON) and 07Fh), 3=1
    BSF INTCON, 7 ; INTCON(7)=((INTCON) and 07Fh), 7=1
